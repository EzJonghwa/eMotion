        ...
        <div class="maincss px-2">
            <div class="maincss p-2">
              ...
              <div class="responsive-subtext p-2 gap-3 d-flex">전기차 - 전기차 비교
              	<button class="btn-othCompare" onclick="location.href='/carCompare'">전기차 - 내연기관차 비교</button>              
              </div>
              ...
              <div class="table-wrapper">
                ...
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarNm" style="width: 50%; height: 4vh; font-size: 12px; font-color: #D2B48C; font-weight: 700;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarNm" style="width: 50%; height: 4vh; font-size: 12px; font-color: #D2B48C; font-weight: 700;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarPrice" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarPrice" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstManufacturer" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondManufacturer" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarBrand" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarBrand" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCategorization" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCategorization" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarCate" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarCate" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstFuelEfficiency" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondFuelEfficiency" style="width: 50%; height: 4vh; font-size: 12px;">
                    
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarEff" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarEff" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarbonFootprint" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarbonFootprint" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCarCo2" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCarCo2" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstBatTypeNm" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondBatTypeNm" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstBatType" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondBatType" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstbatVolNm" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondbatVolNm" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstbatVol" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondbatVol" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstSingle" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondSingle" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstWarm" style="width: 50%; height: 4vh; font-size: 12px;">

                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondWarm" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFirstCold" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecSecondCold" style="width: 50%; height: 4vh; font-size: 12px;">
