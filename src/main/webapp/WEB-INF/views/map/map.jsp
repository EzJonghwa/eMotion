            ...
            // 초기값 설정
                ...
                window.addMarker = function(status, lat, lon, tag) {
                        ...
                        if (status === "llStart") {
                            ...
                            StartMarker.addListener("touched", function(evt) {
                                showStartMarkerInfo(tag);
                            });
                        ...
                        EndMarker.addListener("touched", function(evt) {
                            showEndMarkerInfo(tag);
                        });
                        ...
                        if (StartPoint.lat !== null && StartPoint.lon !== null && EndPoint.lat !== null && EndPoint.lon !== null) {
                            ...
                            mobileqrLink = "tmap://route?lon1=" + StartPoint.lon + "&lat1=" + StartPoint.lat +
                            "&lon2=" + EndPoint.lon + "&lat2=" + EndPoint.lat;
