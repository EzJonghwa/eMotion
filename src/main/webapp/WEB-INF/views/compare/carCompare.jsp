        ...
        <div class="maincss px-2">
            <div class="maincss p-2">
              ...
              <div class="responsive-subtext p-2 gap-3 d-flex">전기차 - 내연기관차 비교
              	<button class="btn-othCompare align-items-center" onclick="location.href='/carElecCompare'">전기차 - 전기차 비교</button>
              </div>
              ...
              <div class="table-wrapper">
                ...
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarNm" style="width: 50%; height: 4vh; font-size: 15px; color: #A52A2A; font-weight: 700;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarNm" style="width: 50%; height: 4vh; font-size: 15px; color: #D2B48C; font-weight: 700;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarPrice" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarPrice" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecManufacturer" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasManufacturer" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarBrand" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarBrand" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCategorization" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCategorization" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarCate" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarCate" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecFuelEfficiency" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasFuelEfficiency" style="width: 50%; height: 4vh; font-size: 12px;">
                    
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarEff" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarEff" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarbonFootprint" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarbonFootprint" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                </div>
                <div class="hstack col">
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="elecCarCo2" style="width: 50%; height: 4vh; font-size: 12px;">
                    	
                  </div>
                  <div class="vr" style="height: 4vh;"></div>
                  <div class="row-6 text-center d-flex justify-content-start align-items-center px-2" id="gasCarCo2" style="width: 50%; height: 4vh; font-size: 12px;">
          ...
          <div class="modal-dialog modal-md">
              <div class="modal-content p-4">
                  <form id="carForm" method="POST" action="#">
                      ...
                      <div class="modal-body d-flex align-items-center justify-content-end">
                        <div class="re_sm me-auto">내 내연기관차</div>
                      </div>
